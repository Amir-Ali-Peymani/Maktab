...
public class SignInAndSignUp extends BaseRepository {
    ...
    public static void signUp() {
        String userName = "alsjfljasjfljjaslfkj";
        String password = "asfasfddasf";
        String email = "asfaf";
        String name = "asfaf";
        String lastName = "asfaf";
        String fatherName = "asfaf";
        String motherName = "asfaf";
        String birthCertificateNumber = "asfaf";
        String nationalIdNumber = "asfaf";
        LocalDate birthDate = LocalDate.of(2003, 12, 2);
        String studentNumber = "asasfhkhaskhf";
        String universityName= "asasfhkhaskhf";
        String universityType= "asasfhkhaskhf";
        String administrative= "asasfhkhaskhf";
        String educationalLevel= "asasfhkhaskhf";
        String approvalType= "asasfhkhaskhf";
        String cities= "asasfhkhaskhf";
        String sex= "asasfhkhaskhf";
...
//        birthDate = inputUtility.getValidBirthDate(Constant.YEAR_MONTH_DAY, Constant.BIRTH_DATE_NOTICE, Constant.
    ...
    public static void signIn(){
        ...
        for (StudentProfile profile : studentProfile){
            if (profile.getUserName().equals(userName) && profile.getPassword().equals(password)){
                LoansMenu.loansMenu(profile.getStudent().getId());
            }
            else {
